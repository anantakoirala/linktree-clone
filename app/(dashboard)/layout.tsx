...
const layout = ({ children }: Props) => {
  ...
  return (
    <div className="flex flex-row relative bg-[#f3f3f1]">
      ...
      <div className="h-screen w-full md:w-3/6 p-4 overflow-y-scroll">
        {children}
      </div>
      {/* Mobile view */}
      ...
      <div className="w-full h-14 md:hidden rounded-full flex flex-row items-center justify-between p-4 fixed bottom-1 bg-white shadow-lg">
        {/* Menu div */}
